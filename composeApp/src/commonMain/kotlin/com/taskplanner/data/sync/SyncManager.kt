package com.taskplanner.data.sync
...
import com.taskplanner.shared.request.SyncOperation
...
class SyncManager(
    ...
    private fun applyServerState(
        tasks: List<com.taskplanner.shared.model.TaskDto>,
        categories: List<com.taskplanner.shared.model.CategoryDto>,
    ) {
